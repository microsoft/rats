...
DPTYPE: dict[str, str] = {
    "in_entry": "rats.processors._legacy.ux._ops.EntryDependencyOp",
    "in_collection": "rats.processors._legacy.ux._ops.CollectionDependencyOp",
    "in_pipeline": "rats.processors._legacy.ux._ops.PipelineDependencyOp",
    "out_entry": "rats.processors._legacy.ux._ops.EntryDependencyOp",
    "out_collection": "rats.processors._legacy.ux._ops.CollectionDependencyOp",
    "out_pipeline": "rats.processors._legacy.ux._ops.PipelineDependencyOp",
}
    ...
    for v in dependencies.values() if dependencies else {}:
        if "_target_" not in v:
            ...
            for attr_k, attr_v in v.items():
                ...
                attr_v._target_ = "rats.processors._legacy.ux._ops.get_pipelineport"
