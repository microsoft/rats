...
from rats.processors._legacy.ux import PipelineConf, UPipeline, UPipelineBuilder
...
class DuplicatePipelineConf(PipelineConf):
    _target_: str = "rats.processors._legacy.pipeline_operations._duplicate_pipeline.DuplicatePipeline.__call__"
