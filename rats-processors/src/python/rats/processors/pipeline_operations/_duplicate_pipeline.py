...
from rats.processors.ux import PipelineConf, UPipeline, UPipelineBuilder
...
class DuplicatePipelineConf(PipelineConf):
    _target_: str = (
        "rats.processors.pipeline_operations._duplicate_pipeline.DuplicatePipeline.__call__"
    )
