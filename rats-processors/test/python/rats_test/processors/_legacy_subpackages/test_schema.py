...
def test_task_conf(register_resolvers_and_configs: None) -> None:
    ...
    processor_type = "rats_test.processors._legacy_subpackages.test_ux_estimators.StandardizeTrain"
    ...
    processor_type = "rats_test.processors._legacy_subpackages.test_schema.IdentityArrays"
    ...
    processor_type = "rats_test.processors._legacy_subpackages.test_ux_arrays.SumArrays"
    input_annotation = {"floats": "float"}
...
def test_combined_conf(register_resolvers_and_configs: None) -> None:
    Acfg = TaskConf(processor_type="rats_test.processors._legacy_subpackages.test_schema.A")
    Bcfg = TaskConf(processor_type="rats_test.processors._legacy_subpackages.test_schema.B")
