...
from rats.processors._legacy_subpackages.dag import DagNode, IProcess
...
class ExampleObjConf:
    _target_: str = "rats_test.processors._legacy_subpackages.test_params_service.ExampleObj"
