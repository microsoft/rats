...
from rats.processors.config import PipelineConfig
from rats.processors.registry import IProvidePipelineCollection, RatsProcessorsRegistryServices
from rats.processors.ux import CombinedPipeline
...
@pytest.fixture
def pipeline_providers(app: RatsApp) -> IProvidePipelineCollection:
    return app.get_service(RatsProcessorsRegistryServices.PIPELINE_PROVIDERS)
