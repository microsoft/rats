...
from rats.processors._legacy.pipeline_operations import (
    CollectionToDict,
    DictToCollection,
    DuplicatePipeline,
    ExposeGivenOutputs,
...
from rats.processors._legacy.pipeline_operations._app_plugin import _PrivateServices
from rats.processors._legacy.registry import ITransformPipeline
from rats.processors._legacy.ux import UPipeline, UPipelineBuilder
