...
from rats.processors.registry import ITransformPipeline
from rats.processors.ux import PipelineRunnerFactory, UPipeline, UPipelineBuilder
...
@pytest.fixture(scope="module")
def write_to_uri_pipeline_builder(app: RatsApp) -> IWriteToUriPipelineBuilder:
    return app.get_service(RatsProcessorsIoServices.WRITE_TO_URI_PIPELINE_BUILDER)
