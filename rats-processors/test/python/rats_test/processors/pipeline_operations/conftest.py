...
from rats.processors.pipeline_operations import (
    CollectionToDict,
    DictToCollection,
    DuplicatePipeline,
    ExposeGivenOutputs,
...
from rats.processors.pipeline_operations._app_plugin import _PrivateServices
from rats.processors.registry import ITransformPipeline
from rats.processors.ux import UPipeline, UPipelineBuilder
