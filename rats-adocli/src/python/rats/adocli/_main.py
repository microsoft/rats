...
from rats.adocli._cli import RawCliRequest
from rats.adocli._di_container import AdocliDiContainer
from rats.logging import PackageLogLevel

logger = logging.getLogger(__name__)


def main(argv: tuple[str, ...]) -> None:
    di_container = AdocliDiContainer(
        RawCliRequest(
            argv=argv,
