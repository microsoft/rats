...
class RatsPycharmCommandGroup(devtools.ClickCommandRegistry):
    _registries: Callable[[], Iterator[devtools.ClickCommandRegistry]]

    def __init__(self, registries: Callable[[], Iterator[devtools.ClickCommandRegistry]]) -> None:
        self._registries = registries

    @devtools.command
    def pycharm(self) -> None:
        cli = click.Group()
