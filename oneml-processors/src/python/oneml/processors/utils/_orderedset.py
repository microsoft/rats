...
class orderedset(Hashable, AbstractSet[_T], Generic[_T]):
    _d: dict[_T, None]
    ...
    def __or__(self, __t: Iterable[_S]) -> orderedset[_T | _S]:
    ...
    @overload
    def union(self: orderedset[_T | _S], *s: Iterable[_S]) -> orderedset[_T | _S]:
        ...
