...
def test_task_conf(register_resolvers_and_configs: None) -> None:
    ...
    processor_type = "oneml_test.processors.test_ux_estimators.StandardizeTrain"
    ...
    processor_type = "oneml_test.processors.test_schema.IdentityArrays"
...
def test_combined_conf(register_resolvers_and_configs: None) -> None:
    Acfg = TaskConf(processor_type="oneml_test.processors.test_schema.A")
    Bcfg = TaskConf(processor_type="oneml_test.processors.test_schema.B")
